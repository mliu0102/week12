...
<template>
  <!--  W3. Library Registration Form -->
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8 offset-md-2">
        <h1 class="text-center">✅ W4. Library Registration Form</h1>
        <p class="text-center">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            ></textarea>
            <div v-if="errors.reason" class= "{'text-success': errors.reason.type === 'success'}">
...
// validation function for the reason input
const validateReason = () => {
  if (formData.value.reason.toLowerCase().includes('friend')){
    errors.value.reason = {message: "Great to have a friend", type:"success"}
  } else{
